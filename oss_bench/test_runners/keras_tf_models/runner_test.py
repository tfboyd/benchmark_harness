...
from test_runners.keras_tf_models import runner


class TestRunBenchmark(unittest.TestCase):
  """Tests for runner.py module."""

# Turned off as keras_tf_models is not running anymore and may never run again.
  ...
  #   run.resnet50_64_gpu_1_synthetic()
